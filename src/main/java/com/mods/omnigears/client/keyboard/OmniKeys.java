...
public class OmniKeys {
    ...
    public static KeyMapping CHARGER_TOGGLE_KEY = new KeyMapping("key.charger_toggle.name", KeyConflictContext.IN_GAME, InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_G, Refs.NAME);
